...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: the nested function can access the internal variable because they're both within the scope of myFunction.
...
newAnimals.push(`name: ${a.animal_name}, scientific: ${a.scientific_name}`);
    });
    return newAnimals;
  }
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    let mappedNames = zooAnimals.map(a => a.animal_name.toLowerCase());
    return mappedNames;
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    let newestAnimals = zooAnimals.filter(a => a.population < 5);
